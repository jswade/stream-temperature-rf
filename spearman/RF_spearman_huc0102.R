...
site_data <- site_data[huc0102_ind,]
disch.month <- disch.month[huc0102_ind,]
slope_metric <- slope_metric[huc0102_ind,]
max_metric <- max_metric[huc0102_ind,]
...
# # Write files to csv
write.csv(maxst_df,"/stream-temperature-rf/data_results/SpearmanRank/HUC_Subset/maxst_huc0102_spearman.csv",row.names=FALSE)
write.csv(slope_df,"/stream-temperature-rf/data_results/SpearmanRank/HUC_Subset/slope_huc0102_spearman.csv",row.names=FALSE)
