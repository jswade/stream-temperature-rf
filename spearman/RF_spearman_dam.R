...
# # Write files to csv
write.csv(maxst_df,"/stream-temperature-rf/data_results/SpearmanRank/Dam_Subset/max_dam_spearman.csv",row.names=FALSE)
write.csv(slope_df,"/stream-temperature-rf/data_results/SpearmanRank/Dam_Subset/slope_dam_spearman.csv",row.names=FALSE)
